                    ...
                    <form action="{{route('test.store')}}" method="post">
                        ...
                        <div class="row">
                            <div class="input-field col s12">
                                <textarea name="question" class="materialize-textarea" data-length="120"></textarea>
                            ...
                            <div class="row">
                                <div class="col s12">
                                    <div class="input-field col s6">
                                        <input name="option1" type="text" data-length="10">
                                        <label for="input_text">Option 1</label>
                                    </div>
                                    <div class="input-field col s6">
                                        <input name="option2" type="text" data-length="10">
                                        <label for="input_text">Option 2</label>
                                    </div>
                                    <div class="input-field col s6">
                                        <input name="option3" type="text" data-length="10">
                                        <label for="input_text">Option 3</label>
                                    </div>
                                    <div class="input-field col s6">
                                        <input name="option4" type="text" data-length="10">
                                        <label for="input_text">Option 4</label>
                                    </div>
                                </div>
                            </div>
                            <div class="input-field col s12">
                                <input name="correct_answer" type="text" data-length="10">
